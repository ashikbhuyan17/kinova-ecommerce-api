...
const swaggerDefinition: SwaggerDefinition = {
  openapi: '3.0.0',
  info: {
    title: 'Kinova E-commerce API Documentation',
    version: '1.0.0',
    description: `

A production-ready REST API built with Node.js, Express, TypeScript, and MongoDB for Kinova E-commerce platform. Manages products, categories, subcategories, blogs, and user authentication.
...
\`\`\`
    ...
    schemas: {
      ...
      Category: {
        ...
        properties: {
          _id: {
            type: 'string',
            description: 'MongoDB ObjectId (Category ID)',
            example: '507f1f77bcf86cd799439011',
          },
          slug: {
            type: 'string',
  ...
  tags: [
    ...
    {
      name: 'SubCategory',
      description: 'SubCategory CRUD operations',
    },
    {
      name: 'Admin',
